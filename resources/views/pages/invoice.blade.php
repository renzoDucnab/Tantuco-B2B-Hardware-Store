    ...
    <div class="container">
          ...
          <div class="row" style="margin-bottom: 20px;" id="downloadtoPDF">
                ...
                <div class="col-sm-4 col-xs-12"
                    ...
                    <h3 style="font-weight:bold;text-transform:uppercase;font-size:21px;"><i>Tanctuco Construction & Trading
                            Corporation</i></h3>
                    ...
                    <div style="display: flex; flex-direction: column;margin-bottom:20px;">
                        <h4 style="margin-bottom: 0px;"><strong>Sales Invoice</strong></h4>
                        <span><b>No:</b>
                    ...
                    <div style="display: flex; flex-direction: column;">
                        <span style="margin-bottom:20px;"><b>Prepared
                                By:</b><br>{{ $superadmin->name ?? 'No superadmin name provided' }}</span>
                        <span><b>Authorized Representative:</b><br>
                            {{ $salesOfficer->name ?? 'No sales officer name provided' }}</span>
                    </div>
