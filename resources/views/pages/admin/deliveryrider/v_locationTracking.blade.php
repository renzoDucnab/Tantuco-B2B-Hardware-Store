...
<script>
    ...
    function enableLocation() {
        Swal.fire({
            ...
            text: 'Allow access to continuously track your location.',
            icon: 'question',
            ...
            if (result.isConfirmed) {
                navigator.geolocation.watchPosition(
                    (position) => {
                        ...
                        fetch(`/api/deliveries/${deliveryId}/update-location`, {
                                method: 'PUT',
                                headers: {
                                ...
                                body: JSON.stringify({
                                    latitude: lat,
                                    longitude: lng,
                                    remarks: "Auto update from watchPosition"
                                })
                            }).then(res => res.json())
                    ...
                    (err) => {
                        Swal.fire('Error', 'Location access denied or unavailable.', 'error');
                    }, {
